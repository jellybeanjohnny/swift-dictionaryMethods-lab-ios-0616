 ...
 */
// write your code here
if let unwantedDroidIndex = starWarsDroids.indexOf("IG-88") {
	starWarsDroids.removeAtIndex(unwantedDroidIndex)
}
...
if starWarsCharacters.isEmpty {
	...
	print("there are \(starWarsCharacters.count) items")
}
 ...
 */
// write your code here
if let addedCharacter = starWarsCharacters.updateValue(starWarsJEdi, forKey: "Jedi") {
 ...
 */
// write your code here
if let removedBountyHunter = starWarsCharacters.removeValueForKey("Bounty Hunters") {
